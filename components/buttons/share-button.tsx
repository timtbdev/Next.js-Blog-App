  ...
  return (
    <>
      <button
        ...
        className="relative inline-flex items-center gap-x-1.5 rounded-r-md px-3 py-2 border-y-[1.5px] border-r-[1.5px] border-gray-300 focus:z-10 bg-gradient-to-t from-gray-200 via-gray-100 to-gray-50 shadow-md shadow-black/5 transition duration-200 hover:bg-gradient-to-tr hover:from-gray-200 hover:via-gray-100 hover:to-gray-50 active:scale-[96%]"
      >
        {isHovering ? (
        ...
        <span className="text-sm hidden sm:block">Хуваалцах</span>
      </button>
