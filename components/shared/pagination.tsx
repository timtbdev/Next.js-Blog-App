...
const Pagination: React.FC<PaginationProps> = ({ page, perPage, totalItems, totalPages, baseUrl, pageUrl }) => {
    return (
        <nav className="mt-8 flex items-center justify-between border-t border-gray-200 px-4 sm:px-0">
            ...
            <div className="hidden md:-mt-px md:flex">
                <Pager totalPages={totalPages} currentPage={page} baseUrl={baseUrl} pageUrl={pageUrl} />
            </div>
