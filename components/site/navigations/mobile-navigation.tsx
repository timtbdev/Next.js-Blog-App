...
const MobileNav: FC<MobileNavProps> = ({ fragment }) => {
  ...
  return (
    <>
      ...
      >
        <Disclosure.Panel className="w-full border-t border-black/5 lg:hidden">
          {menus.map((menu) => (
            <Disclosure.Button
              key={v4()}
              as="a"
            ...
            >
              <div className="group flex items-center gap-x-6 border-b border-black/5 bg-gray-50 px-8 py-3 text-base font-semibold leading-7 text-gray-600 transition-colors hover:bg-gray-200">
