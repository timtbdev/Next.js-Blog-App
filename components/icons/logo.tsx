  ...
  return (
    ...
    >
      ...
      <g transform="translate(12 12) scale(0.5)">
        ...
        ></path>{" "}
        <path
          d="M20,9a1,1,0,0,1-1-1V2a1,1,0,0,1,2,0V8A1,1,0,0,1,20,9Z"
          fill="#1c1917"
        ></path>{" "}
        <path
          d="M10,11a1,1,0,0,1-1-1V4a1,1,0,0,1,2,0v6A1,1,0,0,1,10,11Z"
          fill="#1c1917"
        ></path>{" "}
        <path
          d="M30,11a1,1,0,0,1-1-1V4a1,1,0,0,1,2,0v6A1,1,0,0,1,30,11Z"
          fill="#1c1917"
        ></path>
      </g>
    </svg>
