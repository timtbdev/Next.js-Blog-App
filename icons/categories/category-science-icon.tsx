...
interface CategoryScienceIconProps {
  className?: string;
}

const CategoryScienceIcon: React.FC<CategoryScienceIconProps> = ({
  className = "",
}) => {
  return (
    <svg
    ...
    >
      <g fill="none">
        <path
          opacity=".2"
          d="M15 17H9v-1H5v3h14v-3h-4v1zM4 14h5v-3h6v3h5V9H4v5z"
          fill="#111827"
        ></path>
        <path
...
export default CategoryScienceIcon;
